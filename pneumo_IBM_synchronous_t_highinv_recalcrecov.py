...
#simnum = str(simnum) + '_10kpop'
simnum = str(simnum) + '_' + globalinv*("glob") + "inv" + 'TEST'
...
t = 0
stop_t = 5#vacc_start # 20 years to reach SS without vacc
# initial tot_lambda
...
vacc_stop_t = t+5#t + 1825 # current time + 20 years
...
vacc2_stop_t = t+5#t + 1825 # current time + 20 years
